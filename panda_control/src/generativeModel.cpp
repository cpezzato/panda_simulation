...
#include "generativeModel.h"
  ...
  Eigen::Matrix<double, 3, 1> generativeModel::getG(Eigen::Matrix<double, 7, 1> theta){
    // Due to positive values in the real robot
    theta(1) = -theta(1);
  ...
  g[2] = ((0.33 + sin(theta[1]) * sin(theta[2]) * sin(theta[4]) *
           (-0.088 * cos(theta[5]) + -0.107 * sin(theta[5]))) +
          cos(theta[2]) * sin(theta[1]) * ((0.0825 + sin(theta[3]) *
            ((-0.384 + 0.107 * cos(theta[5])) + -0.088 * sin(theta[5])))
           + cos(theta[3]) * ((-0.0825 + 0.088 * cos(theta[4]) *
             cos(theta[5])) + 0.107 * cos(theta[4]) * sin(theta[5]))))
...
gxprime[3] = sin(theta[0]) * sin(theta[2]) * (cos(theta[3]) *
  ...
  sin(theta[3]) * ((-0.0825 + 0.088 * cos(theta[4]) * cos(theta[5]))
                   + 0.107 * cos(theta[4]) * sin(theta[5]))) +
  cos(theta[0]) * (sin(theta[1]) * (sin(theta[3]) * ((0.384 + -0.107
  * cos(theta[5])) + 0.088 * sin(theta[5])) + cos(theta[3]) *
  ((0.0825 + -0.088 * cos(theta[4]) * cos(theta[5])) + -0.107 *
   cos(theta[4]) * sin(theta[5]))) + cos(theta[1]) * cos(theta
  [2]) * (cos(theta[3]) * ((-0.384 + 0.107 * cos(theta[5])) + -0.088
  * sin(theta[5])) + sin(theta[3]) * ((0.0825 + -0.088 * cos
  (theta[4]) * cos(theta[5])) + -0.107 * cos(theta[4]) * sin
  (theta[5]))));
gxprime[4] = sin(theta[0]) * (cos(theta[2]) * cos(theta[4]) * (
  ...
  + 0.107 * sin(theta[5]))) + cos(theta[0]) * (cos(theta[1]) *
  (cos(theta[4]) * sin(theta[2]) + cos(theta[2]) * cos
   (theta[3]) * sin(theta[4])) * (-0.088 * cos(theta[5]) + -0.107 *
  sin(theta[5])) + sin(theta[1]) * sin(theta[3]) * sin
  (theta[4]) * (0.088 * cos(theta[5]) + 0.107 * sin(theta[5])));
gxprime[5] = cos(theta[0]) * (sin(theta[1]) * (cos(theta[3]) *
  (-0.088 * cos(theta[5]) + -0.107 * sin(theta[5])) + cos
  (theta[4]) * sin(theta[3]) * (-0.107 * cos(theta[5]) + 0.088 *
  sin(theta[5]))) + cos(theta[1]) * (cos(theta[2]) * (sin
  (theta[3]) * (-0.088 * cos(theta[5]) + -0.107 * sin(theta[5])) +
  cos(theta[3]) * cos(theta[4]) * (0.107 * cos(theta[5]) +
  -0.088 * sin(theta[5]))) + sin(theta[2]) * sin(theta[4]) *
  (-0.107 * cos(theta[5]) + 0.088 * sin(theta[5])))) + sin
  (theta[0]) * (sin(theta[2]) * (cos(theta[3]) * cos(theta[4]) *
  (-0.107 * cos(theta[5]) + 0.088 * sin(theta[5])) + sin(theta
  [3]) * (0.088 * cos(theta[5]) + 0.107 * sin(theta[5]))) + cos
                (theta[2]) * sin(theta[4]) * (-0.107 * cos(theta[5])
  + 0.088 * sin(theta[5])));
gxprime[6] = 0.0;
    return(gxprime);
  }
  ...
  gyprime[4] = cos(theta[0]) * (cos(theta[3]) * sin(theta[2]) *
    ...
    + 0.107 * sin(theta[5]))) + sin(theta[0]) * (cos(theta[1]) *
    (cos(theta[4]) * sin(theta[2]) + cos(theta[2]) * cos
     (theta[3]) * sin(theta[4])) * (-0.088 * cos(theta[5]) + -0.107 *
    sin(theta[5])) + sin(theta[1]) * sin(theta[3]) * sin
    (theta[4]) * (0.088 * cos(theta[5]) + 0.107 * sin(theta[5])));
  gyprime[5] = (cos(theta[0]) * (sin(theta[2]) * (sin(theta[3]) *
    ...
    cos(theta[5]) + -0.088 * sin(theta[5]))) + sin(theta[0]) *
                sin(theta[1]) * (cos(theta[3]) * (-0.088 * cos(theta[5])
    + -0.107 * sin(theta[5])) + cos(theta[4]) * sin(theta[3]) * (
    -0.107 * cos(theta[5]) + 0.088 * sin(theta[5])))) + cos
    (theta[1]) * sin(theta[0]) * (cos(theta[2]) * (sin(theta[3]) *
    (-0.088 * cos(theta[5]) + -0.107 * sin(theta[5])) + cos
    (theta[3]) * cos(theta[4]) * (0.107 * cos(theta[5]) + -0.088 *
    sin(theta[5]))) + sin(theta[2]) * sin(theta[4]) * (-0.107 *
    cos(theta[5]) + 0.088 * sin(theta[5])));
  gyprime[6] = 0.0;
    return(gyprime);
  }
  ...
  gzprime[2] = sin(theta[1]) * (cos(theta[2]) * sin(theta[4]) * (
    ...
    cos(theta[4]) * cos(theta[5])) + -0.107 * cos(theta[4]) *
    sin(theta[5]))));
  gzprime[3] = cos(theta[2]) * sin(theta[1]) * (cos(theta[3]) *
    ((-0.384 + 0.107 * cos(theta[5])) + -0.088 * sin(theta[5])) +
    sin(theta[3]) * ((0.0825 + -0.088 * cos(theta[4]) * cos(theta[5]))
                     + -0.107 * cos(theta[4]) * sin(theta[5]))) +
    cos(theta[1]) * (sin(theta[3]) * ((-0.384 + 0.107 * cos(theta[5]))
    + -0.088 * sin(theta[5])) + cos(theta[3]) * ((-0.0825 + 0.088 *
    cos(theta[4]) * cos(theta[5])) + 0.107 * cos(theta[4]) *
    sin(theta[5])));
  gzprime[4] = (cos(theta[4]) * sin(theta[1]) * sin(theta[2]) +
                (cos(theta[2]) * cos(theta[3]) * sin(theta[1]) +
                 cos(theta[1]) * sin(theta[3])) * sin(theta[4])) *
    (-0.088 * cos(theta[5]) + -0.107 * sin(theta[5]));
  gzprime[5] = sin(theta[1]) * (cos(theta[2]) * (sin(theta[3]) *
    (-0.088 * cos(theta[5]) + -0.107 * sin(theta[5])) + cos
    (theta[3]) * cos(theta[4]) * (0.107 * cos(theta[5]) + -0.088 *
    sin(theta[5]))) + sin(theta[2]) * sin(theta[4]) * (-0.107 *
    cos(theta[5]) + 0.088 * sin(theta[5]))) + cos(theta[1]) * (
    cos(theta[4]) * sin(theta[3]) * (0.107 * cos(theta[5]) + -0.088 *
    sin(theta[5])) + cos(theta[3]) * (0.088 * cos(theta[5]) +
    0.107 * sin(theta[5])));
  gzprime[6] = 0.0;
    return(gzprime);
  }
